...
@Plugin
@HomeItemType(value = "Lamps", creationInfo = DeconzDimmableLamp.deCONZCreationInfo.class)
public class DeconzDimmableLamp extends HomeItemAdapter implements HomeItem {
	...
	private static final String MODEL = ("<?xml version = \"1.0\"?> \n"
			...
			+ "  <Action Name=\"LearnDim4\" 	Method=\"learnDim4\" />" + "</HomeItem> ");

	private String lampModel = "";
	private String lampType = "";
	private String lampVersion = "";

	public DeconzDimmableLamp() {
	}
