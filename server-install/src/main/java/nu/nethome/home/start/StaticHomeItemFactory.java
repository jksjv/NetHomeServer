...
public class StaticHomeItemFactory implements HomeItemFactory {
    ...
    private static final HomeItemClassInfo CLASSES_INFO[] = {
            ...
            new HomeItemClassInfo("DeconzBridge", nu.nethome.home.items.deconz.DeconzBridge.class),
            new HomeItemClassInfo("DeconzZHAConsumptionSensor", nu.nethome.home.items.deconz.zhaconsumption.DeconzZHAConsumptionSensor.class),
            new HomeItemClassInfo("DeconzZHAThermometer", nu.nethome.home.items.deconz.zhatemperature.DeconzZHAThermometer.class),
            new HomeItemClassInfo("DeconzZHAPowerSensorCurrent", nu.nethome.home.items.deconz.zhapower.DeconzZHAPowerSensorCurrent.class),
            new HomeItemClassInfo("DeconzZHAPowerSensorVoltage", nu.nethome.home.items.deconz.zhapower.DeconzZHAPowerSensorVoltage.class),
            new HomeItemClassInfo("DeconzZHAPowerSensorPower", nu.nethome.home.items.deconz.zhapower.DeconzZHAPowerSensorPower.class),
            ...
            new HomeItemClassInfo("DeconzLamp", nu.nethome.home.items.deconz.DeconzLamp.class),
            new HomeItemClassInfo("DeconzDimmableLamp", nu.nethome.home.items.deconz.DeconzDimmableLamp.class),
            new HomeItemClassInfo("DeconzDimmableGroupLamp", nu.nethome.home.items.deconz.DeconzDimmableGroupLamp.class),
